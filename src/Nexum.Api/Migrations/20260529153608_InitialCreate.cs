        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstateOrZone = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlockerPinId = table.Column<Guid>(type: "uuid", nullable: true),
                    ReporterPinId = table.Column<Guid>(type: "uuid", nullable: true),
                    ReporterLocation = table.Column<Geometry>(type: "geometry", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlockingAlerts", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LengthM = table.Column<double>(type: "double precision", nullable: false),
                    RoadType = table.Column<string>(type: "text", nullable: false),
                    AllowsVehicles = table.Column<bool>(type: "boolean", nullable: false),
                    AllowsPedestrians = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampEdges", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CampNodes", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "CongestionSnapshots",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    EdgeId = table.Column<Guid>(type: "uuid", nullable: false),
                    DensityScore = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CongestionSnapshots", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastSeenLocation = table.Column<Geometry>(type: "geometry", nullable: true),
                    LastSeenAreaText = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MissingPersonAlerts", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "MissingPersonSightings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    AlertId = table.Column<Guid>(type: "uuid", nullable: false),
                    ReportedBy = table.Column<string>(type: "text", nullable: false),
                    SightingLocation = table.Column<Geometry>(type: "geometry", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MissingPersonSightings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    UserId = table.Column<string>(type: "text", nullable: false),
                    PinLocation = table.Column<Geometry>(type: "geometry", nullable: false),
                    PhotoUrl = table.Column<string>(type: "text", nullable: true),
                    AreaLabel = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParkingPins", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PickupLocation = table.Column<Geometry>(type: "geometry", nullable: false),
                    PickupNodeId = table.Column<Guid>(type: "uuid", nullable: true),
                    DestinationNodeId = table.Column<Guid>(type: "uuid", nullable: false),
                    AssignedVehicleId = table.Column<Guid>(type: "uuid", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    EstimatedArrivalMins = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    CurrentLocation = table.Column<Geometry>(type: "geometry", nullable: true),
                    LastSeenAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShuttleVehicles", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientLocation = table.Column<Geometry>(type: "geometry", nullable: false),
                    Description = table.Column<string>(type: "text", nullable: true),
